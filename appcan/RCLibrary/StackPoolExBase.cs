...
namespace RCLibrary
{
    ...
    public class StackPoolExBase<T> : IItemPool<T> where T : new()
    {
        ...
        #region Constructors
        public StackPoolExBase()
            : this(25, true, true)
        {

        }

        public StackPoolExBase(uint capacity)
        ...
        public StackPoolExBase(uint capacity, bool disposeOnRelease)
        ...
        public StackPoolExBase(uint capacity, bool disposeOnRelease, bool poolStamping)
        {
